...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post('http://localhost:9000/auth/register', {
        username: nome, // substitua 'nome' pela variável que contém o nome do usuário
        password: senha, // substitua 'senha' pela variável que contém a senha do usuário
        userType: tipo, // substitua 'tipo' pela variável que contém o tipo do usuário
      });
  ...
  //       nome: username, // substitua 'username' pela variável que contém o nome do usuário
  //       senha: password, // substitua 'password' pela variável que contém a senha do usuário
  //       tipo: userType, // substitua 'userType' pela variável que contém o tipo do usuário
  //     });

...
public record ChamadoDto(UUID id, String titulo, String descricao,PrioridadeChamado prioridade, UsuarioModel usuarioModel){
    public ChamadoDto(ChamadoModel chamado){
        this(chamado.getId(),chamado.getTitulo(),chamado.getDescricao(),chamado.getPrioridadeChamado(),chamado.getUsuarioModel());
    }
